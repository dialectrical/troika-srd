...
function ThemeProvider(props) {
  const parentTheme = (0, import_react.useContext)(import_themeContext.ThemeContext);
  const {
    children,
  ...
  const value = (0, import_react.useMemo)(() => themeProp && {
    version: 0,
    theme: themeProp,
    scheme,
    tone
  ...
  if (!theme) {
    return /* @__PURE__ */ import_react.default.createElement("pre", null, 'ThemeProvider: no "theme" property provided');
  }
