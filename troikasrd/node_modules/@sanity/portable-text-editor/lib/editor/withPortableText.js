...
var withPortableText = (editor, options) => {
  ...
  var portableTextFeatures = options.portableTextFeatures,
      ...
      incomingPatche$ = options.incomingPatche$,
  ...
  var withScemaTypes = (0, _plugins.createWithSchemaTypes)(portableTextFeatures);
  var withPatches = readOnly ? disablePlugin('withPatches') : (0, _plugins.createWithPatches)(operationToPatches, change$, portableTextFeatures, incomingPatche$);
  var withMaxBlocks = maxBlocks && maxBlocks > 0 ? (0, _plugins.createWithMaxBlocks)(maxBlocks) : disablePlugin('withMaxBlocks');
  var withPortableTextLists = (0, _plugins.createWithPortableTextLists)(portableTextFeatures, change$);
  var withUndoRedo = readOnly ? disablePlugin('withUndoRedo') : (0, _plugins.createWithUndoRedo)(incomingPatche$);
  var withPortableTextMarkModel = (0, _plugins.createWithPortableTextMarkModel)(portableTextFeatures, keyGenerator, change$);
