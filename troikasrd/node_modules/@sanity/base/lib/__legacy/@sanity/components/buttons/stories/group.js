...
function GroupStory() {
  ...
  var buttonColor = (0, _knobs.select)('kind', ['default', 'simple', 'secondary'], 'default', 'props');
  var buttonKind = (0, _knobs.select)('color', [undefined, 'primary', 'success', 'danger', 'white'], undefined, 'props');
