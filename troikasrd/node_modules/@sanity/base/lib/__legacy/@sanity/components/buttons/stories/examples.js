...
exports.ExamplesStory = ExamplesStory;
...
function ExamplesStory() {
  ...
  return /*#__PURE__*/_react.default.createElement(_components.DebugRouterProvider, null, /*#__PURE__*/_react.default.createElement(_components.Container, {
    ...
    items: items,
    onAction: (0, _actions.action)('onClick'),
    disabled: disabled,
    loading: loading,
    color: "primary",
    inverted: true
